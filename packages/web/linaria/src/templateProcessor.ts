...
// @ts-ignore
import stripLines from "@linaria/tags/lib/utils/stripLines";
// @ts-ignore
import { units } from "@linaria/tags/lib/utils/units";
// @ts-ignore
import throwIfInvalid from "@linaria/tags/lib/utils/throwIfInvalid";
// @ts-ignore
import toCSS, { isCSSable } from "@linaria/tags/lib/utils/toCSS";
...
export default function templateProcessor(
    tagProcessor: CustomLinariaProcessor,
